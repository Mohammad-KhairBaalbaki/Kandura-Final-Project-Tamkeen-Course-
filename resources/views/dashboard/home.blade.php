            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-green-600 mt-2">
                        {{ $stats['total_deliverd'] ?? 0 }} {{ __('Delivered') }}
                    </p>
                </div>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-red-600 mt-2">
                        {{ $stats['total_discounts'] ?? 0 }} {{ __('Total Disounts') }}
                    </p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-green-600 mt-2">
                        {{ $stats['active_users'] ?? 0 }} {{ __('Active') }}
                    </p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-pink-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-gray-800">{{ $stats['total_designs'] ?? 0 }}</h3>
                    <p class="text-xs text-green-600 mt-2">
                        {{ $stats['active_designs'] ?? 0 }} {{ __('Active') }}
                    </p>
                </div>
        ...
        <div class="lg:col-span-2 bg-white rounded-lg shadow-md">
            <div class="p-6 border-b">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('orders.index') }}" class="text-sm text-purple-600 hover:text-purple-700 font-semibold">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse(($latest_orders ?? []) as $order)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <span
                                        class="text-sm font-semibold text-green-800">{{ number_format($order->subtotal, 2) }}</span>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <span
                                        class="text-sm font-semibold text-red-800">{{ number_format($order->discount, 2) }}</span>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <span
                                        class="text-sm font-semibold text-green-800">{{ number_format($order->subtotal - $order->discount, 2) }}</span>
                                </td>
                                <td class="px-6 py-4 text-center">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="space-y-3">
                ...
                <a href="{{ route('admins.create') }}"
                    class="flex items-center justify-between p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition group">
                ...
                <a href="{{ route('design_options.create') }}"
                    ...
                    <div class="flex items-center">
                        ...
                        <span
                            class="font-medium text-gray-700 group-hover:text-purple-600">{{ __('Create Design Option') }}</span>
                    </div>
                    <i class="fas fa-arrow-right text-gray-400 group-hover:text-purple-600"></i>
                </a>
